...
CREATE TABLE IF NOT EXISTS `poodle_box`.`courses` (
  ...
  INDEX `fk_courses_users1_idx` (`owner` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `poodle_box`.`users` (
  ...
  `linked_in_profile` VARCHAR(200) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `poodle_box`.`certificates` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_certificates_courses1_idx` (`courses_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `poodle_box`.`content` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_contents_sections1_idx` (`sections_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `poodle_box`.`interests` (
  ...
  INDEX `fk_interests_courses1_idx` (`users_id` ASC) VISIBLE,
  INDEX `fk_interests_tags1_idx` (`tags_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `poodle_box`.`reviews` (
  ...
  `description` LONGTEXT NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_reviews_courses1_idx` (`courses_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `poodle_box`.`sections` (
  ...
  `title` VARCHAR(45) NOT NULL,
  `courses_id` INT(11) NOT NULL,
  `information_link` VARCHAR(200) NULL DEFAULT NULL,
  `locked` TINYINT(4) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `title_UNIQUE` (`title` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `poodle_box`.`users_has_sections` (
  ...
  INDEX `fk_users_has_courses_sections1_idx` (`sections_id` ASC) VISIBLE,
  INDEX `fk_users_has_courses_users1_idx` (`users_id` ASC) VISIBLE,
